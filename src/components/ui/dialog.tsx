...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // Scrim is indigo ink at 50%, not black — matches the shadow tinting.
        "fixed inset-0 z-50 bg-[var(--overlay)] duration-[220ms] data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0",
        className
      )}
      {...props}
    />
